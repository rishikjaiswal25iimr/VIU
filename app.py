...
# ══════════════════════════════════════════════════════════════════════════════
# Final Effective Costs extracted from VIU Summary (Cost per MT of Effective Al)
COST_EFF_PRIMARY   = 783343.64
COST_EFF_SECONDARY = 772462.46
COST_EFF_NOTCH     = 786635.81

# Dictionary containing grade-specific metallurgical constraints
grades_data = {
    "Commodity Structural (IS2062/E250)": {"eff_target": 0.48, "therm_lim": 5.5, "rec_lim": 3.50, "inc_lim": 0.060, "reblow_lim": 2.50, "sec_notch_max": 1.00},
    "TMT / Rebar (Fe500D)":               {"eff_target": 0.50, "therm_lim": 4.0, "rec_lim": 3.20, "inc_lim": 0.050, "reblow_lim": 2.30, "sec_notch_max": 0.80},
    "HSLA / API (API X70)":               {"eff_target": 0.55, "therm_lim": 2.5, "rec_lim": 2.80, "inc_lim": 0.040, "reblow_lim": 2.00, "sec_notch_max": 0.30},
    "IF Steel (Deep Draw IF)":            {"eff_target": 0.59, "therm_lim": 1.5, "rec_lim": 2.15, "inc_lim": 0.032, "reblow_lim": 1.55, "sec_notch_max": 0.10},
    "Electrical Steel (CRGO / CRNO)":     {"eff_target": 0.60, "therm_lim": 1.1, "rec_lim": 2.05, "inc_lim": 0.031, "reblow_lim": 1.50, "sec_notch_max": 0.00},
}

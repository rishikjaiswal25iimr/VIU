"""
VIU DASHBOARD & SOLVER – FeSi70 vs Si Metal
================================================
Integrated Value-in-Use comparison & Optimal Substitution Solver.

Tab 1: Value-in-Use Dashboard
Tab 2: Optimal Substitution Solver
"""
...
# ══════════════════════════════════════════════════════════════════════════════
st.set_page_config(
    page_title="VIU & Solver - FeSi vs Si Metal",
    page_icon="🔥",
    layout="wide",
)
...
# Colour palette - Solver specifically
...
# ══════════════════════════════════════════════════════════════════════════════
# HELPER: Plotly layout templates & KPI
# ══════════════════════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════════════════════
with st.sidebar:
    st.markdown("## 🔥 VIU & Solver Dashboard")
    st.divider()
...
# ══════════════════════════════════════════════════════════════════════════════
if comparison_selection == "Not selected":
    st.info("Please select substitution combination from the sidebar to run the VIU analysis & Solver.")
    st.stop()
...
# TABBED INTERFACE
# ══════════════════════════════════════════════════════════════════════════════
tab1, tab2 = st.tabs(["🔥 VIU Dashboard", "⚗️ Substitution Solver"])
...
with tab1:
    ...
    # 2. FeSi70 Break-Even
    # Derived algebraically from the sensitivity chart's x-intercept (where net_fesi_sens == 0)
    ...
    with be3:
        st.markdown(kpi("Min. Credits Needed", f"₹{max(0, min_credits):,.0f}", f"Current Credits: ₹{Total_Op_Credits:,.0f} | {cred_stat}", cred_col), unsafe_allow_html=True)

...
with st.sidebar:
    ...
    if comparison_selection != "Not selected":
        ...
        P_Alloy_Target = st.number_input("Pure Mn Addition Target (kg/T)", value=4.0, step=0.1, min_value=1.0, max_value=20.0, format="%.2f")
...
Active_Mn_per_Heat = P_Heat_Size * P_Alloy_Target
...
Substitution_Ratio = Alloy_Per_MT_Mn_MC / Alloy_Per_MT_Mn_Briq # MT of MC FeMn replaced by 1 MT of Briquette

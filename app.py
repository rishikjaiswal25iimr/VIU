...
with st.sidebar:
    ...
    if comparison_selection != "Not selected":
        ...
        R_Yield       = st.slider("Yield Realization",       0.10, 1.00, 0.80, 0.01)
        ...
        SiMetal_Consumption_FY = st.number_input("Consumption Baseline (MT)", value=5000, step=100, min_value=100, max_value=100000)
...
Gross_Op_Benefits = (
    ...
    Benefit_Yield + Benefit_CaWire + Benefit_Retreatment
)

# 11. Lost Iron Credit Penalty (FeSi contains Fe, Si Metal does not)
Iron_Credit_FeSi = P_FeSi_Fe * P_Scrap_Price
Total_Op_Credits = Gross_Op_Benefits - Iron_Credit_FeSi

# 12. Active Silicon Cost Math & Base Price Delta
...
Direct_Cost_Saving_Per_MT_SiMetal = Cost_Per_Si_Delta * (P_SiMetal_Si * P_SiMetal_Rec)
...
with col_r:
    ...
    benefit_names = [
        ...
        "Yield Improvement", "Ca-Wire Reduction", "Re-treatment Reduction",
    ]
    benefit_values = [
        Benefit_Power, Benefit_Electrode, Benefit_Throughput,
        Benefit_Stability, Benefit_Slag, Benefit_Cleanliness,

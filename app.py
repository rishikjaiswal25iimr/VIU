# ==============================================================================
# ⚗️ FEV80 VS NITROVAN VIU DASHBOARD (TAB 1 ONLY)
# 
# INSTRUCTIONS:
# 1. This file contains the exact equivalent logic from the FeV vs NV Excel workbook.
# 2. Mock sidebar variables are included at the top so this script can be run standalone.
# 3. For your production app, simply copy everything from `with tab1:` and paste it 
#    into your main application's tab container.
# ==============================================================================
...
# --- MOCK SIDEBAR VARIABLES (Replace with your actual sidebar inputs) ---
P_FeV_Price = 2950000; P_NV_Price = 2500000; P_Power_Tariff = 6.5; P_Electrode_Cost = 240
P_Steel_Value = 60000; P_LF_Minute_Cost = 850; P_LF_Retreatment_Cost = 15000
P_FeV_V = 0.80; P_NV_V = 0.77; P_FeV_Rec = 0.95; P_NV_Rec = 0.92
P_FeV_Eff = 1.0; P_NV_Eff = 1.1; P_Chill_FeV = 1.8; P_Chill_NV = 3.0; P_SpHeat_Steel = 0.75
Active_V = 0.20; P_Heat_Size = 190; P_Cycle_Time = 45; P_LF_Efficiency = 0.45; P_Dissolution_Time_Saved = 2.5; P_Graphite_Factor = 0.010
FeV_Overdose = 0.03; NV_Overdose = 0.015; Retreatment_FeV = 0.04; Retreatment_NV = 0.025
Reject_FeV = 0.00015; Reject_NV = 0.00008; Yield_Loss_FeV = 0.00005; Yield_Loss_NV = 0.00003
R_Power = 0.40; R_Electrode = 0.50; R_Throughput = 0.40; R_Stability = 0.10; R_Reblow = 0.80; R_Cleanliness = 0.40; R_Yield = 0.50
NV_Consumption_FY = 1200; Substitution_Pct = 0.50

tab1 = st.container()

# ══════════════════════════════════════════════════════════════════════════════
# COPY EVERYTHING BELOW THIS LINE INTO YOUR APP
# ══════════════════════════════════════════════════════════════════════════════
with tab1:
    ...
    Energy_Penalty = (Delta_Temp * P_SpHeat_Steel) / (3.6 * P_LF_Efficiency)
    ...
    with col_l:
        ...
        with km2: st.markdown(kpi("Nitrovan Cost/MT ESU", f"₹{Cost_Per_ESU_NV:,.0f}", f"@ {P_NV_V*100:.0f}% V × {P_NV_Rec*100:.0f}% rec × 1.1x eff.", "kpi-card-green"), unsafe_allow_html=True)
